...
(4, 'Charlie', 'Wallin', 'CW@email.com', 'charliewallin', 'M');
...
ALTER TABLE `invoices`
 ADD PRIMARY KEY (`InvoiceID`), ADD KEY `Relationship3` (`UserID`);

--
-- Indexes for table `lineitems`
--
ALTER TABLE `lineitems`
 ADD PRIMARY KEY (`Line_ItemID`), ADD KEY `Relationship4` (`InvoiceID`);
...
--
ALTER TABLE `users`
 ADD PRIMARY KEY (`UserID`), ADD UNIQUE KEY `StateID` (`StateID`), ADD KEY `Relationship2` (`StateID`);
